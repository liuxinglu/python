...
while running:
    ...
    # 生成子弹，需要控制发射频率
    # 首先判断玩家飞机没有被击中
    if not enemy_life == 0 and key_pressed[K_SPACE]:
    ...
    for enemy_down in enemies1_down:
        count +=1;
        enemies_down.add(enemies1_down)
        break
...
font_fail = pygame.font.Font(None, 48)
text = font.render('Score: '+ str(score), True, (255, 0, 0))
text_fail = font.render("YOU WIN : "+ str(count)+'ENEMIES', True, (255, 255, 0))
text_rect = text.get_rect()
text_rect_fail = text_fail.get_rect()
text_rect.centerx = screen.get_rect().centerx
text_rect_fail.centerx = screen.get_rect().centerx
text_rect.centery = screen.get_rect().centery + 24
text_rect_fail.centery = screen.get_rect().centery + 55
screen.blit(game_over, (0, 0))
screen.blit(text, text_rect)
screen.blit(text_fail, text_rect_fail)
